...
https://shetura36.shinyapps.io/Data608_Uber_Final_Project/
...
The scope of each map view is limited to daily and/or hourly view for the selected borough. This tool is useful for understanding pickup zones throughout the five boroughs of New York City. The interactive map allows end-user to see establishments arounds high pick zones, and the report gives a quick overview of top neighborhoods and zip codes.
